...
const file_orm_options_proto_rawDesc = "" +
	...
	"\aversion\x18\x11 \x01(\v2\x13.orm.VersionOptionsR\aversion\"\xd1\x01\n" +
	...
	"\x0eVersionOptionsB,Z*github.com/protobuf-orm/protobuf-orm/ormpbb\beditionsp\xe8\a"

var file_orm_options_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_orm_options_proto_goTypes = []any{
	...
	(*RpcAdd)(nil),         // 5: orm.RpcAdd
	(*RpcGet)(nil),         // 6: orm.RpcGet
	(*RpcPatch)(nil),       // 7: orm.RpcPatch
	(*RpcErase)(nil),       // 8: orm.RpcErase
	(*Index)(nil),          // 9: orm.Index
	(Type)(0),              // 10: orm.Type
	(*Ref)(nil),            // 11: orm.Ref
}
var file_orm_options_proto_depIdxs = []int32{
	5,  // 0: orm.RpcOptions.add:type_name -> orm.RpcAdd
	6,  // 1: orm.RpcOptions.get:type_name -> orm.RpcGet
	7,  // 2: orm.RpcOptions.patch:type_name -> orm.RpcPatch
	8,  // 3: orm.RpcOptions.erase:type_name -> orm.RpcErase
	0,  // 4: orm.MessageOptions.rpc:type_name -> orm.RpcOptions
	9,  // 5: orm.MessageOptions.indexes:type_name -> orm.Index
	10, // 6: orm.FieldOptions.type:type_name -> orm.Type
	4,  // 7: orm.FieldOptions.version:type_name -> orm.VersionOptions
	11, // 8: orm.EdgeOptions.bind:type_name -> orm.Ref
	11, // 9: orm.EdgeOptions.from:type_name -> orm.Ref
